          ...
          <AnimatedSection>
            <div className="flex justify-between items-center mb-6">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    {profile?.lga || profile?.address || 'Location not provided'},{' '}
                    {profile?.state || 'Location not provided'}
                  </p>
                </div>
              </div>
              <div className="flex gap-3">
                ...
                >
                  Joined since{' '}
                  {new Date(profile?.userId?.registrationDate).toLocaleDateString()}
                </button>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
              ...
              <div className="space-y-4">
                ...
                <div className="bg-white p-4 rounded-lg shadow">
                  ...
                  <div className="mt-2 flex gap-2 flex-wrap">
                    {profile.jobsCanDo?.length > 0 ? (
                      profile.jobsCanDo.map((job, index) => (
                        <span
                          key={index}
                          className="bg-gray-200 px-3 py-1 rounded-full text-sm"
                        >
              ...
              <div className="space-y-4">
                ...
                <div className="bg-white p-4 rounded-lg shadow">
                  ...
                  <p className="mt-1 p-2 bg-gray-100 rounded">
                    {profile.alcoholConsumption || 'N/A'}
                  </p>
                </div>
                <div className="bg-white p-4 rounded-lg shadow">
                  <label className="block text-sm font-medium text-gray-700">
                ...
                {/* Added: Jobs I Cannot Do */}
                <div className="bg-white p-4 rounded-lg shadow">
                  <label className="block text-sm font-medium text-gray-700">
                    Jobs I Cannot Do
                  </label>
                  <div className="mt-2 flex gap-2 flex-wrap">
                    {profile.jobsCannotDo?.length > 0 ? (
                      profile.jobsCannotDo.map((job, index) => (
                        <span
                          key={index}
                          className="bg-gray-200 px-3 py-1 rounded-full text-sm"
                        >
...
//       try {
//         setLoading(true);
//         const response = await axios.get(`${import.meta.env.VITE_BACKEND_URL}/api/profile/aprofile/${slug}`);
...
//     const comment = { name: userName, text: newComment, createdAt: new Date().toISOString() };
//     const updatedComments = [...comments, comment];
//     setComments(updatedComments);
//     setNewComment('');
//     setUserName('');
...
//     try {
//       await axios.post(`${import.meta.env.VITE_BACKEND_URL}/api/profile/${slug}/comments`, comment);
...
//         style: { background: 'white', color: 'red' },
//       });
//       // Revert comments if the API call fails
//       setComments(comments);
//     }

//     // Local storage as a fallback (optional)
//     localStorage.setItem(`school_${slug}_comments`, JSON.stringify(updatedComments));
//   };
...
//                 >
//                   Joined since{' '}
//                   {new Date(profile?.userId?.registrationDate || Date.now()).toLocaleDateString()}
//                 </button>
//                 <button className="bg-red-500 text-white px-4 py-2 rounded-lg hover:bg-red-600 transition">
//                   Cancel
//                 </button>
...
//                       <input
//                         type="radio"
//                         checked={profile?.WDYD !== undefined && profile?.WDYD !== 'bicycle'} // Assuming WDYD indicates vehicle ownership
//                         readOnly
//                         className="mr-2"
//                       />
//                       Yes
...
//                       <input
//                         type="radio"
//                         checked={profile?.WDYD === undefined || profile?.WDYD === 'bicycle'}
//                         readOnly
//                         className="mr-2"
//                       />
//                       No
...
//                   <div className="mt-2 flex gap-2 flex-wrap">
//                     {profile?.WDYD ? (
//                       <span className="bg-gray-200 px-3 py-1 rounded-full text-sm">{profile.WDYD}</span>
//                     ) : (
//                       <p className="text-gray-500">N/A</p>
//                     )}
//                   </div>
...
//                   <p className="mt-1 p-2 bg-gray-100 rounded">{profile.state || 'N/A'}</p>
//                 </div>
//                 <div className="bg-white p-4 rounded-lg shadow">
...
//                   <p className="mt-1 p-2 bg-gray-100 rounded">{profile.alcoholUse || 'N/A'}</p>
//                 </div>
//                 <div className="bg-white p-4 rounded-lg shadow">
//                   <label className="block text-sm font-medium text-gray-700">Are you a smoker?</label>
//                   <p className="mt-1 p-2 bg-gray-100 rounded">{profile.alcoholUse ? (profile.alcoholUse === 'Never' ? 'No' : 'Yes') : 'N/A'}</p>
//                 </div>
//               </div>
//             </div>
//           </AnimatedSection>
