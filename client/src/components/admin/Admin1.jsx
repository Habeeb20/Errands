...
//       className="p-6 bg-white rounded-lg shadow-md"
//     >
//       <h2 className="text-2xl font-bold mb-4">Telephone Booking</h2>
//       <p className="text-gray-600">
//         <TelephoneBooking />
//       </p>
//     </motion.div>
...
//               className={`w-full flex items-center p-3 rounded-lg transition duration-300 ${
//                 activeTab === "telephone" ? "bg-green-600" : "hover:bg-green-600"
//               }`}
    ...
    <div className="flex min-h-screen bg-gray-100">
      ...
      <div className="flex-1 ml-0 md:ml-64 p-6">
        ...
        <AnimatePresence mode="wait">
          ...
          {activeTab === "erranders" && <ErrandersContent key="erranders" />}
          {activeTab === "users" && <UsersContent key="users" />}
          {activeTab === "telephone" && <TelephoneBookingContent key="telephone" />}
          {activeTab === "settings" && <SettingsContent key="settings" />}
        </AnimatePresence>
      </div>
